...
toggleshowday7() {
  ...
  ngOnInit() {
      ...
      this.date1 = data.forecast.forecastday[0].date;
      ...
      this.date2 = data.forecast.forecastday[1].date;
      ...
      this.date3 = data.forecast.forecastday[2].date;
      ...
      this.date4 = data.forecast.forecastday[3].date;
      ...
      this.date5 = data.forecast.forecastday[4].date;
      ...
      this.date6 = data.forecast.forecastday[5].date;
      ...
      this.date7 = data.forecast.forecastday[6].date;
